...
#include "MosaicOcularsDialog.hpp"
#include "ui_mosaicOcularsDialog.h"
...
MosaicOcularsDialog::MosaicOcularsDialog(MosaicOculars* pluginPtr,
			   QList<CCD *>* ccds,
			   QList<Ocular *>* oculars,
			   QList<Telescope *>* telescopes,
			   QList<Lens *> *lenses)
	: StelDialog("MosaicOculars")
	, plugin(pluginPtr)
	, ccdMapper(Q_NULLPTR)
...
{
	ui = new Ui_mosaicOcularsDialogForm;
	this->ccds = ccds;
...
MosaicOcularsDialog::~MosaicOcularsDialog()
{
	if (dialog)
	{
...
void MosaicOcularsDialog::retranslate()
{
	if (dialog)
	{
...
void MosaicOcularsDialog::closeWindow()
{
	setVisible(false);
	StelMainView::getInstance().scene()->setActiveWindow(Q_NULLPTR);
}

void MosaicOcularsDialog::deleteSelectedCCD()
{
...
void MosaicOcularsDialog::deleteSelectedOcular()
{
...
void MosaicOcularsDialog::deleteSelectedTelescope()
{
...
void MosaicOcularsDialog::deleteSelectedLens()
{
	if (askConfirmation())
	{
...
void MosaicOcularsDialog::insertNewCCD()
{
...
void MosaicOcularsDialog::insertNewOcular()
{
...
void MosaicOcularsDialog::insertNewTelescope()
{
...
void MosaicOcularsDialog::insertNewLens()
{
...
void MosaicOcularsDialog::moveUpSelectedSensor()
{
...
void MosaicOcularsDialog::moveUpSelectedOcular()
{
...
void MosaicOcularsDialog::moveUpSelectedTelescope()
{
...
void MosaicOcularsDialog::moveUpSelectedLens()
{
...
void MosaicOcularsDialog::moveDownSelectedSensor()
{
	int index = ui->ccdListView->currentIndex().row();
...
void MosaicOcularsDialog::moveDownSelectedOcular()
{
	int index = ui->ocularListView->currentIndex().row();
...
void MosaicOcularsDialog::moveDownSelectedTelescope()
{
	int index = ui->telescopeListView->currentIndex().row();
...
void MosaicOcularsDialog::moveDownSelectedLens()
{
	int index = ui->lensListView->currentIndex().row();
...
void MosaicOcularsDialog::createDialogContent()
{
	ui->setupUi(dialog);
	...
	connectBoolProperty(ui->checkBoxControlPanel,		"MosaicOculars.flagGuiPanelEnabled");
	connectIntProperty(ui->guiFontSizeSpinBox,		"MosaicOculars.guiPanelFontSize");
	connectBoolProperty(ui->checkBoxInitialFOV,		"MosaicOculars.flagInitFOVUsage");
	connectBoolProperty(ui->checkBoxInitialDirection,	"MosaicOculars.flagInitDirectionUsage");
	connectBoolProperty(ui->checkBoxResolutionCriterion,	"MosaicOculars.flagShowResolutionCriteria");
	connectBoolProperty(ui->requireSelectionCheckBox,	"MosaicOculars.flagRequireSelection");
	connectBoolProperty(ui->limitStellarMagnitudeCheckBox,	"MosaicOculars.flagAutoLimitMagnitude");
	connectBoolProperty(ui->hideGridsLinesCheckBox,		"MosaicOculars.flagHideGridsLines");
	connectBoolProperty(ui->scaleImageCircleCheckBox,	"MosaicOculars.flagScaleImageCircle");
	connectBoolProperty(ui->semiTransparencyCheckBox,	"MosaicOculars.flagSemiTransparency");
	connectIntProperty(ui->transparencySpinBox,	        "MosaicOculars.transparencyMask");
	connectBoolProperty(ui->checkBoxDMSDegrees,		"MosaicOculars.flagDMSDegrees");
	connectBoolProperty(ui->checkBoxHorizontalCoordinates,	"MosaicOculars.flagHorizontalCoordinates");
	connectBoolProperty(ui->checkBoxTypeOfMount,		"MosaicOculars.flagAutosetMountForCCD");
	connectBoolProperty(ui->checkBoxTelradFOVScaling,	"MosaicOculars.flagScalingFOVForTelrad");
	connectBoolProperty(ui->checkBoxCCDFOVScaling,		"MosaicOculars.flagScalingFOVForCCD");
	connectBoolProperty(ui->checkBoxCCDMaxExposureTime,     "MosaicOculars.flagMaxExposureTimeForCCD");
	connectBoolProperty(ui->checkBoxToolbarButton,		"MosaicOculars.flagShowOcularsButton");
	connectIntProperty(ui->arrowButtonScaleSpinBox,	        "MosaicOculars.arrowButtonScale");
	connectBoolProperty(ui->checkBoxShowCcdCropOverlay,	"MosaicOculars.flagShowCcdCropOverlay");
	connectBoolProperty(ui->checkBoxShowCcdCropOverlayPixelGrid,	"MosaicOculars.flagShowCcdCropOverlayPixelGrid");
	connectIntProperty(ui->guiCcdCropOverlayHSizeSpinBox,	"MosaicOculars.ccdCropOverlayHSize");
	connectIntProperty(ui->guiCcdCropOverlayVSizeSpinBox,	"MosaicOculars.ccdCropOverlayVSize");
	connectBoolProperty(ui->contourCheckBox,		"MosaicOculars.flagShowContour");
	connectBoolProperty(ui->cardinalsCheckBox,		"MosaicOculars.flagShowCardinals");
	connectBoolProperty(ui->alignCrosshairCheckBox,		"MosaicOculars.flagAlignCrosshair");
	connectBoolProperty(ui->checkBoxShowFocuserOverlay,	"MosaicOculars.flagShowFocuserOverlay");
	connectBoolProperty(ui->checkBoxUseSmallFocuser,	"MosaicOculars.flagUseSmallFocuserOverlay");
	connectBoolProperty(ui->checkBoxUseMediumFocuser,	"MosaicOculars.flagUseMediumFocuserOverlay");
	connectBoolProperty(ui->checkBoxUseLargeFocuser,	"MosaicOculars.flagUseLargeFocuserOverlay");
	ui->textColorToolButton->setup("MosaicOculars.textColor", "text_color", "MosaicOculars");
	ui->lineColorToolButton->setup("MosaicOculars.lineColor", "line_color", "MosaicOculars");
	ui->focuserColorToolButton->setup("MosaicOculars.focuserColor", "focuser_color", "MosaicOculars");
...
void MosaicOcularsDialog::setupTelradFOVspins(Vec4f fov)
{
...
void MosaicOcularsDialog::updateCCDRotationAngles()
{
	if (dialog->isVisible())
	{
...
void MosaicOcularsDialog::updateTelradCustomFOV()
{
...
void MosaicOcularsDialog::updateSuffixes()
{
...
void MosaicOcularsDialog::initAboutText()
{
	...
	html += "<tr width=\"30%\"><td><strong>" + q_("Version") + ":</strong></td><td>" + MOSAICOCULARS_PLUGIN_VERSION + "</td></tr>";
	html += "<tr><td><strong>" + q_("License") + ":</strong></td><td>" + MOSAICOCULARS_PLUGIN_LICENSE + "</td></tr>";
...
void MosaicOcularsDialog::updateGuiOptions()
{
