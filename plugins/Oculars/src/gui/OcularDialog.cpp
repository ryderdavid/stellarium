...
void OcularDialog::initAboutText()
{
	...
	html += "<tr><td rowspan=\"8\"><strong>" + q_("Contributors") + ":</strong></td><td>Bogdan Marinov</td></tr>";
	...
	html += "<tr><td>Ryder Cobean (" + q_("Mosaic planning functionality") + ") &lt;<a href='https://github.com/ryderdavid'>github.com/ryderdavid</a>&gt;</td></tr>";
	html += "</table>";
