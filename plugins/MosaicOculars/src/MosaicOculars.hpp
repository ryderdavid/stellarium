...
#ifndef MOSAICOCULARS_HPP
#define MOSAICOCULARS_HPP
...
#define MOSAICOCULARS_PLUGIN_VERSION "1.0.0"
#define MOSAICOCULARS_PLUGIN_LICENSE "GNU GPLv2 or later"
...
//! @class Oculars
//! @ingroup oculars
class MosaicOculars : public StelModule
{
	Q_OBJECT
	...
	friend class MosaicOcularsGuiPanel;

public:
	MosaicOculars();
	~MosaicOculars() override;
...
public slots:
	...
	//! Necessary because of the way model/view management in the MosaicOcularsDialog
	//! is implemented.
	void updateLists();
...
private:
	...
	MosaicOcularsDialog *ocularDialog;
	...
	class MosaicOcularsGuiPanel * guiPanel;
...
class MosaicOcularsStelPluginInterface : public QObject, public StelPluginInterface
{
	Q_OBJECT
