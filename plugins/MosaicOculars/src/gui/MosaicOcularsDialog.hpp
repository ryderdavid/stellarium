...
#ifndef MOSAICOCULARSDIALOG_HPP
#define MOSAICOCULARSDIALOG_HPP
...
class Ui_mosaicOcularsDialogForm;
...
//! @ingroup oculars
class MosaicOcularsDialog : public StelDialog
{
	Q_OBJECT

public:
	MosaicOcularsDialog(MosaicOculars* plugin, QList<CCD *>* ccds, QList<Ocular *>* oculars, QList<Telescope *>* telescopes, QList<Lens *>* lenses);
	~MosaicOcularsDialog() override;
