...
#ifndef MOSAICOCULARSGUIPANEL_HPP
#define MOSAICOCULARSGUIPANEL_HPP
...
//! @ingroup oculars
class MosaicOcularsGuiPanel : public QGraphicsWidget
{
	Q_OBJECT

public:
	MosaicOcularsGuiPanel(MosaicOculars* mosaicOcularsPlugin,
			QGraphicsWidget * parent = Q_NULLPTR,
			Qt::WindowFlags wFlags = Qt::Widget);
	~MosaicOcularsGuiPanel() override;
...
private:
	MosaicOculars* mosaicOcularsPlugin;
